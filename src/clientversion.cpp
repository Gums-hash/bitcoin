// Copyright (c) 2012-present The Bitcoin Moola Core developers
 ...
 *
 * IMPORTANT:
 * - UA_NAME is the default "name" used when composing the BIP14 user agent
 *   (see FormatSubVersion). It is NOT the GUI application name.
 * - If you want wallets/nodes to clearly identify as Bitcoin Moola on the wire,
 *   change this from "Satoshi" to something coin-specific.
 */
const std::string UA_NAME("BitcoinMoolaCore");
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Keep upstream attribution present.
    // (This is a safe, non-breaking change that avoids accidental removal.)
...
{
    // Point this to your fork/repo if you have one. Keeping Bitcoin's URL doesn't crash anything,
    // but it’s clearer for your assignment to show your own project URL.
    const std::string URL_SOURCE_CODE = "<https://example.com/bitcoinmoola>";
